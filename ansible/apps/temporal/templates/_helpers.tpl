...
{{/*- printf "cassandra-%s.cassandra.%s.svc.cluster.local," $i $.Release.Namespace -*/}}
{{- define "cassandra.hosts" -}}
{{- range $i := (until (int 1)) }}
{{- printf "cassandra.%s.svc.cluster.local," $.Release.Namespace -}}
{{- end }}
{{- end -}}
...
*/}}
{{/*- printf "cassandra-0.cassandra.%s.svc.cluster.local" $.Release.Namespace -*/}}
